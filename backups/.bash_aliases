...
alias ttt='tmux set -g pane-border-status top && tmux set -g pane-border-format "#[bg=green] #[fg=white] #{pane_index} #(ps --no-headers -t #{pane_tty} -o args -O-c)"'
alias tpnum='bind Left select-pane -L \; display-pane -d 5000'
