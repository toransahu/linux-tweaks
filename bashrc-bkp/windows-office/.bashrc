...
alias idle='python -m idlelib.idle -e'
alias gpush='git push origin master'

alias cdw='cd D:Toran/WorkSpace/'

alias cdgit='cd /D/Toran/WorkSpace/git-utils/'

alias p_git='/D/Toran/WorkSpace/git-utils/'
...
alias bashrc-bkp='cp ~/.bashrc /d/Toran/WorkSpace/linux-tweaks/bashrc-bkp/windows-office/'alias cdss='cd /d/Toran/P\ Docs/Salary\ Slip/'
